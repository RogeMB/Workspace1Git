...
public class Principal {
	public static void main(String[] args) {
		...
		s = new Sala(1, numFilas, butacasPorFila, precio, pelicula);
					...
					if (s.hayButacas()) {
						do {
							...
							if (hayLibres) {
								...
								System.out.print("¿Qué butaca de la fila " + fila +" desea comprar "
										+ "(introduzca un número no válido para cancelar): ");
								butaca = Leer.datoInt();
